...
###############相关变量#################
#可以访问到zabbix页面的URL
URL='http://xxxxxxxxxxx/zabbix/api_jsonrpc.php'
ZABBIX_URL='http://xxxxxxxxxxxx/zabbix/index.php'
CHART_URL='http://xxxxxxxxxxxx/zabbix/chart.php'
#登录zabbix的账号密码
USERNAME='xxxxxxxxxx'
